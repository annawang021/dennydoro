...
const Bed = React.forwardRef(({ formattedTime, ...props }, ref) => {
  return (
    <div style={{ position: "fixed", bottom: 0, right: 80, zIndex: 3 }}>
      <Tooltip label="click to reset total focus time back to 0!" placement="left">
        <div>
          <button ref={ref} {...props}>
            <svg xmlns="http://www.w3.org/2000/svg" width="120%" height="100%" viewBox="0 0 373 120" fill="none">
              <g filter="url(#filter0_d_83_87)">
                <path d="M4 56C4 25.0721 29.0721 0 60 0H313C343.928 0 369 25.0721 369 56V56C369 86.9279 343.928 112 313 112H60C29.0721 112 4 86.9279 4 56V56Z" fill="none" />
              </g>
              <defs>
                <filter
                  id="filter0_d_83_87"
